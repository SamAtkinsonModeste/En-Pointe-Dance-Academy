...
lily = {
    'Positive': [emoji.emojize("I can prove I'm more than perfect steps :relieved_face:")],
    'Neutral': [emoji.emojize(
        "More pressure? I can't handle this forever :neutral_face:")],
    'Negative': [emoji.emojize(
        "I'll never escape my mother's expectations.:anxious_face_with_sweat:")],

}

zoe = {
    'Positive': [emoji.emojize("This is my chance to prove I belong in ballet :flexed_biceps:")],
    'Neutral': [emoji.emojize(
        "I get it, but it's still all about rules :smirking_face:")],
    'Negative': [emoji.emojize(
        "Conform? No way. I'll never fit into this world :weary_face:")],
}

sara = {
    'Positive': [emoji.emojize("This is the push I need to finally improve. :flexed_biceps:")],
    'Neutral': [emoji.emojize(
        "I want to believe, but what if I'm not good enough?:thinking_face:")],
    'Negative': [emoji.emojize(
        "I'll never live up to this pressure.:weary_face:")],
}
